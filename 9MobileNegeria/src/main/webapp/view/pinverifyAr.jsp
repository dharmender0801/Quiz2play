...
<body>
	<!--banner-section-->
	<form class="form-submit pb-4 pt-2" action="/v1/pinverify/"
		method="post">
					...
					<div class="row justify-content-between">
						<div class="col-md-5">
							<img
								...
								class="img-fluid  d-block" alt="spin_0"> <input
						...
						<div class="col-md-4 my-auto">
							<img src="${pageContext.request.contextPath}/images/logo.png"
								...
								class="img-fluid d-block mx-auto txt_0 " alt="text"> <input
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
								accept="^\d{10}$" type="text" maxlength=6
								class="form-control tel_0 d-block mx-auto" name="pin"
								placeholder="أدخل رقم التعريف الشخصي الخاص بك للاشتراك">
							<p class="text-center" style="color: red; font-size: 27px;">${response}</p>
							<button type="submit" class="btn d-block mx-auto btn_0 mt-4">تأكيد</button>
