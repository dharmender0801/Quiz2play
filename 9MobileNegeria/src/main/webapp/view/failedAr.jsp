...
<body>
	<!--image_section-->
	<section style="position: absolute; top: 0;" class="image_1 position-relative py_5">
		...
		<section class="content_1 text-center position-absolute">
			<div class="container-fluid">
				<img src="${pageContext.request.contextPath}/images/logo.png"
					class="img-fluid d-block logo mx-auto">
				<div class="row d_flex justify-content-between mt-4">
					...
					<div class="col-md-6 my-auto p_a col_2">
						...
						<p>لم يتم اشتراكك بالخدمة. للاشتراك ارسل ١ إلى 4540</p>
						<a href="#" class="img-fluid d-inline-block ancr mt-4"><i
							class="far fa-times-circle d-block"></i></a>
					</div>
		...
		<p class="p_pos position-absolute text-center mt_4"style="direction:rtl">اهلا بك بخدمة quiz2play، لإلغاء الاشتراك أرسل 0 مجانا الى رقم الخدمة 4540. علما ان سعر الرسالة المستلمة للصفحة الواحدة هو 240 دينار عراقي</p>
		<!--x-content_section-x-->
	</section>
	<!--x-image_section-x-->
