...
<body>
	<!--banner-section-->
	<form class="form-submit pb-4 pt-2" action="/zain-ksa/redirect/" method="post">
		<section class="position-relative bg_0 py_5">
			...
			<span class="phra_0">
						<p class="text-center" style="direction:rtl">اهلا بك بخدمة quiz2play، لإلغاء الاشتراك أرسل 0 مجانا الى رقم الخدمة 4540. علما ان سعر الرسالة المستلمة للصفحة الواحدة هو ${price} SAR دينار عراقي </p>
					</span> 
				</div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <img src="images/0101.gif" class="img-fluid d-block">
        </div>
  ...
  <div class="modal fade" id="exampleModal_1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img src="images/020202.gif" class="img-fluid d-block">
          </div>
          <!-- <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary">Save changes</button>
  ...
  <div class="modal fade" id="exampleModal_2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img src="images/0303.gif" class="img-fluid d-block">
          </div>
          <!-- <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary">Save changes</button>
