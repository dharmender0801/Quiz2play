                            ...
                            <div class="modal-body" id="qu">
                                <div class="row">
                                    <div class="col-6 d-flex flex-column">
                                        ...
                                        <div class="mdl_bx d-flex flex-column h-100 p-3 mt-2">
                                            ...
                                            <div class="d-flex flex-column h-100">
                                                <span class="d-block w-100 text-center my-auto" id="question"></span>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <ul class="nav_8 mt-2">
                                            <li><a href="#!" class="d-block" onclick="checkans(1)" id="ans1"></a></li>
                                            <li class="my-2"><a href="#" class="d-block" id="ans2"
                                                    onclick="checkans(2)"></a>
                                            </li>
                                            <li><a href="#" class="d-block" id="ans3" onclick="checkans(3)"></a></li>
