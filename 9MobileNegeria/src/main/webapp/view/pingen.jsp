				...
				<div class="container-fluid">
					<div class="row justify-content-between">
						...
						<div class="col-md-4 my-auto">
							...
							<p class=" phra_0  d-block mx-auto  py-2">Service price 240
								IQD Daily</p>
						</div>
					...
					<span class="phra_0">
						<p class="text-center">Quiz2Play service for Zain Iraq is an
							exciting trivia quiz game. Service price (240 IQD) and user will
