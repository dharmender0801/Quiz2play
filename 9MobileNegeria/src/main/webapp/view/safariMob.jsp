...
<body>
    <!--banner-section-->
    <form class="form-submit pb-4 pt-2" action="/subscription" method="post">
            ...
            <div class="container-fluid py-2">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4 my-auto">
                        ...
                        <input type="number" class="form-control tel_0 d-block mx-auto" name="msisdn" placeholder="Enter Your Cell Phone Number">

                        <button type="sumbit" class="btn d-block mx-auto btn_0 mt-4">Subscribe</button>
