<%@page pageEncoding="UTF-8" %>
	...
	<body>
		<!--banner-section-->
		<form class="form-submit pb-4 pt-2" action="/mobily-ksa/redirect/" method="post">
					...
					<div class="container-fluid">
						<div class="row justify-content-between">
							...
							<div class="col-md-4 my-auto">
								...
								<p class="text-center phra_0 mt-4" style="direction:rtl">${msg1}</p>
							</div>
						...
						<div class="three-content">
							<div class="wdt_8 d-flex justify-content-center mt-5">
								<a class="d-block" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><img
										src="${pageContext.request.contextPath}/images/0101.gif"
										class="img-fluid d-block"></a>
								<a class="d-block mx-4" href="#" data-bs-toggle="modal"
									data-bs-target="#exampleModal_1"><img
										src="${pageContext.request.contextPath}/images/020202.gif"
										class="img-fluid d-block"></a>
								<a class="d-block" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal_2"><img
