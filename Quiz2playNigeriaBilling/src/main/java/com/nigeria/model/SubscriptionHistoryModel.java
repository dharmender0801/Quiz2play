...
@Entity
@Table(name = "appstore_users_subscription_history")
public class SubscriptionHistoryModel {
	...
	public String toString() {
		return "SubscriptionHistoryModel [id=" + id + ", activeStatus=" + activeStatus + ", advId=" + advId
				+ ", amount=" + amount + ", cancelChannel=" + cancelChannel + ", cancelDate=" + cancelDate
				+ ", cancelReason=" + cancelReason + ", channel=" + channel + ", chargeAmount=" + chargeAmount
				+ ", chargeDate=" + chargeDate + ", expiryDate=" + expiryDate + ", graceDate=" + graceDate
				+ ", keyword=" + keyword + ", mappedItemtypeId=" + mappedItemtypeId + ", meta1=" + meta1 + ", meta2="
				+ meta2 + ", meta3=" + meta3 + ", msisdn=" + msisdn + ", operatorResponse=" + operatorResponse
				+ ", partnerTransactionId=" + partnerTransactionId + ", price=" + price + ", productId=" + productId
				+ ", productName=" + productName + ", productType=" + productType + ", serviceId=" + serviceId
				+ ", serviceName=" + serviceName + ", subscriptionDate=" + subscriptionDate + ", subscriptionId="
				+ subscriptionId + ", transactionId=" + transactionId + ", userId=" + userId + ", currency=" + currency
				+ ", validity=" + validity + ", language=" + language + "]";
	}
